...
```{r}
rm(bay_wq, p1, wq_10, wq_11, wq_12, wq_13, wq_14, wq_15, wq_16, wq_17, wq_18, wq_19)
```
...
```{r}
coordinates(wq) <- c("Longitude", "Latitude")
```
...
```{r}
variogram_model <- variogramST(MeasureValue~1, wq)
```
